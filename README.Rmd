...
d2 <- gtrends(c("Coca Cola"), geo = "US", time="2005-02-04 2005-02-08", low_search_volume=TRUE, onlyInterest=TRUE)
plot(d2)
...
```{r}
x <- ts_gtrends(keyword = c("Coca cola",), geo = "US", time="2005-02-04 2005-02-08")
tsbox::ts_plot(x)
```
